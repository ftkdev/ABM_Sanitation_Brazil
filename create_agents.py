...
def create_agents(loc, scale, size, max_alpha, atrat_range):
    ...
    atratividade_min = [a-np.random.uniform(0, atrat_range) for a in atratividade]
    atratividade_max = [a+np.random.uniform(0, atrat_range) for a in atratividade]
...
# teste = create_agents(1.5, 0.25, 40)
# print(teste)
